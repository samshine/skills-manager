  ...
  return (
    ...
    >
      <div className="relative group" style={{ WebkitAppRegion: "no-drag" } as CSSProperties}>
        ...
        <input
          type="text"
          className="w-[220px] h-[30px] pl-8 pr-9 rounded-[5px] border border-border-subtle bg-surface text-[12px] text-secondary placeholder-faint focus:outline-none focus:border-border transition-colors"
      ...
      <div className="flex items-center gap-3.5" style={{ WebkitAppRegion: "no-drag" } as CSSProperties}>
        ...
        <button className="text-muted hover:text-tertiary transition-colors p-1.5 rounded outline-none">
